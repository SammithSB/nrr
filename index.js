...
var rows = 7;
var cols = 8;
var ind_runs = [110 + 151 + 210+89, 6.5+20 + 20 + 20, 111 + 85+152 + 144, 20+20+14.5 + (17 + (5.0 / 6)) ]
var pak_runs = [189 + 148 + 135 + 152, 39 + 17 + (5 / 6) + 18 + (4 / 6), 147 + 144 + 134 + 151, 80]
var nam_runs = [115 + 98 + 144+110, 20+20 + 20 + 19 + (1.0 / 6), 163+109 + 189 + 160, 20+60]
var scot_runs = [156 + 109 + 60+85, 20+20 + 20 + 20, 89+172 + 190 + 115, 6.5+40 + 19 + (1.0 / 6)]
var nz_runs = [111 + 172 + 134+163, 20+20 + 20 + 14.5, 110+111 + 156 + 135, 20+40 + 18 + (4.0 / 6)]
var afg_runs = [144 + 160 + 147 + 190, 80, 210 + 98 + 148 + 60, 59 + 20]
...
var wi_runs = [55 + 143 + 142 + 169, 20 + 20 + 20 + 20, 139 + 56 + 144 + 189, 20 + 26 + (4.0 / 6) + 20]
var sa_runs = [118 + 144 + 86 + 146, 20 + 38 + 13.5 + (1.0 / 6), 121 + 143 + 142 + 84, 79 + (4.0 / 6)]
var aus_runs = [121 + 125 + 155 + 78, 37 + 19 + (4.0 / 6) + 6 + (2 / 6
), 154 + 126 + 118 + 73, 51 + (4.0 / 6) + 20]
var sl_runs = [172 + 137 + 154 + 142 + 189, 78 + (5.0 / 6) + 20, 171 + 155 + 146 + 163 + 169, 20 + 20 + 19 + 17 + (5.0 / 6) + 20]
...
const india = ['india', 4, 2, 2, 0, 0, 4, india_nrr]
const pak = ['pak', 4, 4, 0, 0, 0, 8, pak_nrr]
const nz = ['nz', 4, 3, 1, 0, 0, 6, nz_nrr]
const nam = ['nam', 3, 1, 2, 0, 0, 2, nam_nrr]
const scot = ['scot', 3, 0, 3, 0, 0, 0, scot_nrr]
const afg = ['afg', 4, 2, 2, 0, 0, 4, afg_nrr]
const aus = ['aus', 4, 3, 1, 0, 0, 6, aus_nrr]
